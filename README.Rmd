...
Note that the estimate $\hat{\beta}_{12}$ is positive. Yet, significant number of
the $\hat{\gamma}_{12}^2$ values are negative. Moreover, the magnitude and sign of
$\hat{\gamma}_{12}^2$ are contingent upon the specific combination of `X1b` and
`X2b` variables utilized in the analysis.
