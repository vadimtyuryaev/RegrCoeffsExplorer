...
to a single unit. Furthermore, in excess of 15 &#37 of these differences 
...
significant number of the $\hat{\gamma}_{12}^2$ values are negative. The magnitude 
and sign of $\hat{\gamma}_{12}^2$ are contingent upon the specific combination
